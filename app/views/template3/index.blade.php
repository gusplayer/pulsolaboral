...
<html lang="en">
    ...
    @foreach($usuarios as $usuario)
        ...
        <!-- ALL STYLESHEETS -->
        <link href="template3/css/all-stylesheet.css" rel="stylesheet">
        <!--<link rel="alternate stylesheet" type="text/css" href="template3/css/colors/green.css" title="default">-->
    ...
    <body>
                ...
                <div class="tp-banner" >
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            <!-- MAIN IMAGE --> 
                            <img src="img/fondos/{{$diseno->url}}"  alt="video_forest"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">                             
                            <!-- LAYER NR. 1 -->
        ...
        <section id="work-experience">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 section-heading">
                        <div class="heading animated" data-animation="fadeInUp" data-animation-delay="200">EXPERIENCIA LABORAL</div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <div class="desc animated" data-animation="fadeInUp" data-animation-delay="200"><i class="fa fa-heart"></i><br>
                           ...
                           <a href="http://pulsolaboral.com/" target="_blank"><img src="img/logo-white.png" width="250"></a>
                        </div>
                        <!-- Copyright Ends -->
						<div class="line"></div>
                        <!-- ToTop Starts -->
        ...
        <!-- JAVASCRIPTS STARTS
            ========================================================================= --> 
        <!-- Bootstrap --> 
        <script src="template3/js/jquery-1.10.2.min.js"></script> 
        <script src="template3/js/bootstrap.min.js"></script> 
        <!-- Style Switcher --> 
       
        <!-- Animation --> 
        <script type="text/javascript" src="template3/js/animation/jquery.appear.js"></script> 
        <!-- AJAX Contact Form --> 
        <script type="text/javascript" src="template3/js/contact/contact-form.js"></script> 
        <!-- Lightbox --> 
        <script src="template3/lightbox/ekko-lightbox.js"></script> 
        <!-- Isotope --> 
        <script src="template3/js/isotope/jquery.isotope.min.js"></script> 
        <script src="template3/js/isotope/custom-isotope.js"></script> 
        <!-- Slider Revolution 4.x Scripts --> 
        <script type="text/javascript" src="template3/rs-plugin/js/jquery.themepunch.plugins.min.js"></script> 
        <script type="text/javascript" src="template3/rs-plugin/js/jquery.themepunch.revolution.js"></script> 
        <script>
            var revapi;
        ...
        <!-- Owl Carousel --> 
        <script src="template3/owl-carousel/owl-carousel/owl.carousel.js"></script> 
        <!-- Custom --> 
        <script src="template3/js/custom.js"></script> 
        <!-- Parallex --> 
        <script src="template3/js/parallex/script.js"></script> 
        <!-- ScrollTo --> 
        <script src="template3/js/nav/jquery.scrollTo.js"></script> 
        <script src="template3/js/nav/jquery.nav.js"></script> 
        <!-- Sticky --> 
        <script type="text/javascript" src="template3/js/sticky/jquery.sticky.js"></script> 
        <!-- Donut Chart --> 
        <script type="text/javascript" src="template3/js/progress-bars/jquery.donutchart.js"></script> 
        <script>
        ...
        <!-- Retina --> 
        <script type="text/javascript" src="template3/js/retina/retina.js"></script>
    </body>
</html>